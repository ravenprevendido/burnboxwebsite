...
const ImageCard = () => {
  return (
    <div className="relative overflow-hidden group aspect-[4/5] min-w-full bg-gradient-to-tr from-neutral-700 via-neutral-500 to-neutral-300 shadow-md cursor-pointer transition-transform">
      ...
      <Image 
        ...
        layout="responsive"
        alt='Hover image'
        src='/1000008556-removebg-preview.png'
